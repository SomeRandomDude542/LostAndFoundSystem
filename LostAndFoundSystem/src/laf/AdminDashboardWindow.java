...
public class AdminDashboardWindow extends JFrame {
	...
	private void showHallOfFame() {
	    ...
	    dialog.setLocationRelativeTo(null);
	    // ✅ REMOVED setExtendedState - JDialog doesn't support it
	    // Instead, just set size to screen size (already done above)
	    dialog.setResizable(true); // Allow user to resize if needed
	    dialog.getContentPane().setLayout(null);
	    ...
	    JScrollPane scrollPane = new JScrollPane();
	    ResponsiveScaler.scale(scrollPane, 20, 85, 460, 450);
	    scrollPane.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
	    scrollPane.setBorder(null);
	...
	private void addTeamMember(JPanel parent, String name, String role, String imagePath) {
	    ...
	    Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
	    int scaledWidth = (int) (440 * ((double) screenSize.width / 548));
	    int scaledHeight = (int) (120 * ((double) screenSize.height / 358));
	    ...
	    memberPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, scaledHeight));
	    memberPanel.setPreferredSize(new Dimension(scaledWidth, scaledHeight));
	    ...
	    // ✅ Scaled photo size
	    int photoSize = (int) (100 * ((double) screenSize.width / 548));
	    
	    // Profile picture with dynamic scaling
	    ...
	    lblPhoto.setBounds(15, 10, photoSize, photoSize);
	    lblPhoto.setHorizontalAlignment(SwingConstants.CENTER);
	    lblPhoto.setBorder(BorderFactory.createLineBorder(new Color(90, 14, 36), 2));
	    ...
	    // ✅ Scaled text positions
	    int textX = 15 + photoSize + 15;
	    
	    // Name
	    JLabel lblName = new JLabel(name);
	    lblName.setFont(new Font("Tahoma", Font.BOLD, 16));
	    lblName.setBounds(textX, 20, scaledWidth - textX - 20, 25);
	    ...
	    lblRole.setBounds(textX, 50, scaledWidth - textX - 20, 20);
	    ...
	    lblStar.setBounds(textX, 75, 30, 30);
	    ...
	    lblAchievement.setBounds(textX + 30, 76, 250, 20);
	...
	private void addPlaceholderMember(JPanel parent, String name, String role) {
	    ...
	    lblName.setBounds(textX, 30, scaledWidth - textX - 20, 25);
	    memberPanel.add(lblName);
	    ...
	    lblRole.setBounds(textX, 60, scaledWidth - textX - 20, 20);
	    memberPanel.add(lblRole);
